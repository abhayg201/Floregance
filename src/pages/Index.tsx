...
const Index = () => {
  ...
  const homeSchema = {
    ...
    "@type": "WebSite",
    "name": "Floregance",
    "url": "https://floregance.com",
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://floregance.com/products?search={search_term_string}",
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-craft-50 pt-16 pb-20">
          <div className="container mx-auto">
            <h2 className="sr-only">Our Values</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <article className="p-6 animate-fade-up" style={{ animationDelay: "100ms" }}>
              ...
              <article className="p-6 animate-fade-up" style={{ animationDelay: "200ms" }}>
              ...
              <article className="p-6 animate-fade-up" style={{ animationDelay: "300ms" }}>
        ...
        <section className="bg-craft-50 py-20">
